    ...
    render() {
        return (
            ...
            <Container className="my-5">
                ...
                <Row>
                    {this.state.dataMenu !== null? this.state.menu.map((e, i) => {
                        return (
                            <Col className="my-1 col-6" xl={3} md={4} sm={6} key={i}>
                                <div
                                    className="btn"
                                    onClick={() => {
                                        this.setState({popupNama: this.state.dataMenu[e].nama});
                                        this.setState({popupHarga: this.state.dataMenu[e].harga});
                                ...
                                >
                                    <Card className="shadow-sm">
                                        ...
                                        <Card.Body className="text-center">
                                            ...
                                            <Card.Text>{uangRupiah(this.state.dataMenu[e].harga)}</Card.Text>
                                        </Card.Body>
                                    </Card>
                                </div>
                            </Col>
